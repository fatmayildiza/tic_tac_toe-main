...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildTurn() {
    return Container(
      child: Padding(
        ...
        child: Center(
          child: Text(
            _turnOfO ? 'SIRA SENDE O' : 'SIRA SENDE X',
  ...
  void _checkTheWinner() {
    ...
    if (_xOrOList[0] == _xOrOList[1] &&
        ...
        _xOrOList[0] != '') {
      _showAlertDialog('KAZANAN', _xOrOList[0]);
      return;
    }
    ...
    if (_xOrOList[3] == _xOrOList[4] &&
        ...
        _xOrOList[3] != '') {
      _showAlertDialog('KAZANAN', _xOrOList[3]);
      return;
    }
    ...
    if (_xOrOList[6] == _xOrOList[7] &&
        ...
        _xOrOList[6] != '') {
      _showAlertDialog('KAZANAN', _xOrOList[6]);
      return;
    }
    ...
    if (_xOrOList[1] == _xOrOList[4] &&
        ...
        _xOrOList[1] != '') {
      _showAlertDialog('KAZANAN', _xOrOList[1]);
      return;
    }
    ...
    if (_xOrOList[2] == _xOrOList[5] &&
        ...
        _xOrOList[2] != '') {
      _showAlertDialog('KAZANAN', _xOrOList[2]);
      return;
    }
  ...
  void _showAlertDialog(String title, String winner) {
    showAlertDialog(
        ...
        title: title,
        content:
            winner == '' ? 'OYUN BİTTİ' : 'KAZANAN ${winner.toUpperCase()}',
